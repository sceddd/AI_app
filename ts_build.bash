while getopts ":b" opt; do
  case $opt in
    b)
      ...
      torch-model-archiver --model-name facereg --version 1.0 --serialized-file ./model/face/weight/vgg_face_dag.pth --handler ./model/face/recog_model.py --extra-files ./model/face/util.zip --export-path ./model/model_store -f
      ...
      torch-model-archiver --model-name obdet --version 1.0 --handler ./model/object_detection/detect_model.py --serialized-file ./model/object_detection/weight/yolov8n.pt --export-path ./model/model_store -f
    ;;
    \?)
